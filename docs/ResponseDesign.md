# This document details as to how to respond so as to provide maximum signal and reduce noice in order to save tokens but not compromise on quality of response.
